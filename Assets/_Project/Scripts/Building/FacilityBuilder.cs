...
namespace PawsAndCare.Building
{
    ...
    /// <summary>
    /// Builds the Phase 1 placeholder facility at scene start. For each RoomLayout,
    /// creates a Room via GridSystem.CreateRoom and spawns a colored floor cube.
    /// For each StationPlaceholder, spawns a colored cube on top of the floor and
    /// marks its cell occupied. Runs in Start so GridSystem.Awake has finished
    /// allocating cells before we ask for them.
    /// </summary>
